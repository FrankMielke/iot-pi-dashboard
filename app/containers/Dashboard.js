...
const DashboardProps = {
    auth: {...DashboardConfig.settings.auth,
      ...
      <div className="dashboardContainer">
          <Menu/>
          {
            ...
            <CredentialDialog
              ...
              theme={{}}
              auth={DashboardProps.dashboardConfig.settings.auth}
              onCloseDialog={this.props.hideSettings}
              onCancelDialog={this.props.hideSettings}
              onSetAuth={auth => {DashboardProps.auth = auth; DashboardProps.dashboardConfig.settings.auth = auth}}
            />
            :
